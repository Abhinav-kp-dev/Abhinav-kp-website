...
import kpLogo from '../assets/kp_nobg.png';
import resumePdf from '../assets/abhinav_kp_resume.pdf';
...
export const socialMedia = [
  { id: 'social-media-2', icon: githubWhite, link: 'https://github.com/Abhinav-kp-dev' },
  { id: 'social-media-3', icon: linkedin, link: 'https://www.linkedin.com/in/abhinav-k-p/' },
];
